...
public class ReturnCurrencyBackDialogFragment extends DialogFragment {
    ...
    public boolean currencyBacked = false;

    public static ReturnCurrencyBackDialogFragment newInstance(Service service) {
        ReturnCurrencyBackDialogFragment frag = new ReturnCurrencyBackDialogFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        final View mView = inflater.inflate(R.layout.dialog_service_to_do_sold, container, false);
    ...
    private void giveBackCurrency(final Service service) {
        final DatabaseReference timeCurrencyRef = FirebaseDatabase.getInstance()
                .getReference("Users").child(service.getClientId()).child("timeCurrency");
                ...
                if(dataSnapshot.exists()) {
                    for(DataSnapshot ds : dataSnapshot.getChildren()) {
                        if(ds.getValue(String.class).equals(service.getId())) {
                            ...
                            currencyBacked = true;
                            Toast.makeText(getContext(), "Oferta anulowana, cofnięto czasowalutę", Toast.LENGTH_LONG).show();
